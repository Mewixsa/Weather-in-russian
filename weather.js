...
async function getApi() {
    ...
    const formatDate = (dat) => {
        ...
        const dayOfWeek = new Intl.DateTimeFormat('ru', { weekday: 'long' }).format(date);
    ...
    document.getElementById("wind_mph").innerHTML = `${Math.round(wind_mph)} км/ч`;
    ...
    let AM6_wind = document.getElementById("AM6_wind").innerHTML = `${Math.round(result.forecast.forecastday[0].hour[6].wind_kph)} км/ч`;
    ...
    let AM10_wind = document.getElementById("AM10_wind").innerHTML = `${Math.round(result.forecast.forecastday[0].hour[10].wind_kph)} км/ч`;
    ...
    let PM14_wind = document.getElementById("PM14_wind").innerHTML = `${Math.round(result.forecast.forecastday[0].hour[14].wind_kph)} км/ч`;
    ...
    let PM18_wind = document.getElementById("PM18_wind").innerHTML = `${Math.round(result.forecast.forecastday[0].hour[18].wind_kph)} км/ч`;
    ...
    let PM22_wind = document.getElementById("PM22_wind").innerHTML = `${Math.round(result.forecast.forecastday[0].hour[22].wind_kph)} км/ч`;
